...
# template-terraform-azure-ephemeral-certificate-slave
...
```hcl
module "template-terraform-azure-ephemeral-certificate-slave" {
  source = "github.com/BuunGroup-Templates/template-terraform-azure-ephemeral-certificate-slave?ref=v1.0.0" // Replace with correct source and version
